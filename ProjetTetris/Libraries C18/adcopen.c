...
{    
    ...
    ANCON0 = config3 >> 8; // VBG Selection and port configuration
    ANCON1 = config3;  //port configuration
...
{    
    ...
    ANCON0 = portconfig >> 8; // VBG Selection and port configuration
    ANCON1 = portconfig;  //port configuration
...
#elif defined (ADC_V13) || defined (ADC_V13_1) || defined (ADC_V13_2) || defined (ADC_V13_3)
void OpenADC( unsigned char config,
              unsigned char config2,
              unsigned char config3)
{
